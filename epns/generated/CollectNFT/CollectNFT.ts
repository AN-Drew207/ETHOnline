...
export class CollectNFTApproval extends ethereum.Event {
  get params(): CollectNFTApproval__Params {
    return new CollectNFTApproval__Params(this);
  }
}

export class CollectNFTApproval__Params {
  _event: CollectNFTApproval;

  constructor(event: CollectNFTApproval) {
    this._event = event;
  }
...
export class CollectNFTApprovalForAll extends ethereum.Event {
  get params(): CollectNFTApprovalForAll__Params {
    return new CollectNFTApprovalForAll__Params(this);
  }
}

export class CollectNFTApprovalForAll__Params {
  _event: CollectNFTApprovalForAll;

  constructor(event: CollectNFTApprovalForAll) {
    this._event = event;
  }
...
export class CollectNFTTransfer extends ethereum.Event {
  get params(): CollectNFTTransfer__Params {
    return new CollectNFTTransfer__Params(this);
  }
}

export class CollectNFTTransfer__Params {
  _event: CollectNFTTransfer;

  constructor(event: CollectNFTTransfer) {
    this._event = event;
  }
...
export class CollectNFT__getSourcePublicationPointerResult {
  value0: BigInt;
  value1: BigInt;
...
export class CollectNFT__tokenDataOfResultValue0Struct extends ethereum.Tuple {
  get owner(): Address {
...
export class CollectNFT extends ethereum.SmartContract {
  static bind(address: Address): CollectNFT {
    return new CollectNFT("CollectNFT", address);
  }
  ...
  getSourcePublicationPointer(): CollectNFT__getSourcePublicationPointerResult {
    let result = super.call(
    ...
    return new CollectNFT__getSourcePublicationPointerResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getSourcePublicationPointer(): ethereum.CallResult<
    CollectNFT__getSourcePublicationPointerResult
  > {
    let result = super.tryCall(
      "getSourcePublicationPointer",
      "getSourcePublicationPointer():(uint256,uint256)",
    ...
    return ethereum.CallResult.fromValue(
      new CollectNFT__getSourcePublicationPointerResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  tokenDataOf(tokenId: BigInt): CollectNFT__tokenDataOfResultValue0Struct {
    let result = super.call(
      "tokenDataOf",
    ...
    return changetype<CollectNFT__tokenDataOfResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_tokenDataOf(
    tokenId: BigInt
  ): ethereum.CallResult<CollectNFT__tokenDataOfResultValue0Struct> {
    let result = super.tryCall(
      "tokenDataOf",
      "tokenDataOf(uint256):((address,uint96))",
      [ethereum.Value.fromUnsignedBigInt(tokenId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<CollectNFT__tokenDataOfResultValue0Struct>(value[0].toTuple())
    );
  }
