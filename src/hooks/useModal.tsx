    ...
    return (
      <Transition.Root show={isShow} as={Fragment}>
        <Dialog
          ...
          static
          className={clsx(
            { ["bg-transparent-color-gray-200"]: hasBg },
            "fixed z-[500] inset-0 overflow-y-auto",
          )}
        ...
        >
          <div
            className="flex items-center justify-center px-4 text-center sm:block sm:p-0"
          ...
          >
            ...
            >
              <div className="inline-block align-bottom text-left overflow-hidden transform transition-all sm:align-middle my-8 sm:w-full sm:max-w-lg ">
                <div className="bg-transparent p-6">{children}</div>
              </div>
            </Transition.Child>
          </div>
        </Dialog>
